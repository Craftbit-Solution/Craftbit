      ...
      <div className="px-6 pt-12 pb-20 relative z-10">
        <div className="text-center">
          ...
          >
            ...
            and design solutions. We build websites that captivate, convert, and
            scale.
          </motion.p>
          ...
          >
            <Button
              size="lg"
              className="bg-linear-to-r from-[#0D3082] to-[#3E92CC] hover:opacity-90 text-white px-8 py-6 rounded-full text-lg font-medium shadow-xl shadow-[#0D3082]/25 hover:shadow-2xl hover:shadow-[#0D3082]/30 transition-all duration-300 hover:-translate-y-1 group"
            >
              Start Your Project
