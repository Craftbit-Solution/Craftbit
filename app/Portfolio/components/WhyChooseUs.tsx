          ...
          {reasons.map((reason, index) => (
            ...
            >
              <motion.div whileHover={{ y: -5 }}>
                <Card className="group h-full bg-white px-3 py-4 shadow-sm hover:shadow-xl transition-all duration-500 border border-slate-100">
                  <div className="flex items-start gap-6">
                    <div
                      className={`shrink-0 w-14 h-14 rounded-2xl bg-linear-to-br ${reason.gradient} flex items-center justify-center group-hover:scale-110 transition-transform duration-300`}
                    >
