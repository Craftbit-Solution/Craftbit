    ...
    return (
        <section className="py-12">
            ...
            >
                ...
                <span className="text-blue-600 font-medium text-sm tracking-wider uppercase">Vision to Reality</span>
            ...
            <div className="max-w-4xl mx-auto px-6 relative">
                ...
                >
                    ...
                    >
                        Let's discuss how we can bring your vision to life with precision, passion, and purpose.
