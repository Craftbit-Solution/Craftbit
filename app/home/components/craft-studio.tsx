            ...
            {comparisons.map((col) => (
              ...
              >
                ...
                <div className="flex items-center justify-between gap-3 sm:flex-col sm:items-center sm:justify-center sm:gap-0">
                  <div
                    className={`min-w-[100px] text-left text-xs font-semibold tracking-widest uppercase sm:mb-2 sm:min-w-0 sm:text-center ${col.featured ? 'text-[#3E92CC]' : 'text-white/40'}`}
                  >
                    {col.label}
                  </div>

                  <div className="font-display relative text-right text-xl font-bold text-white sm:mb-2 sm:text-center sm:text-2xl">
                    {col.price}
                  </div>

                  <div
                    className={`relative hidden text-center text-xs leading-relaxed sm:block ${col.featured ? 'text-white/75' : 'text-white/40'}`}
                  >
                    {col.desc}
                  </div>
                </div>
                ...
                <p
                  className={`mt-1.5 text-left text-xs leading-relaxed sm:hidden ${col.featured ? 'text-white/70' : 'text-white/35'}`}
                >
                  {col.desc}
                </p>
              </div>
